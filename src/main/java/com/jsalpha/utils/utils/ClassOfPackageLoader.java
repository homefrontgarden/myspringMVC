...
/**
 * @author dengjingsi * 加载指定包下的类的工具类
 */
public class ClassOfPackageLoader {
    /**
     * 加载path目录下的packageName中所有类 * @param path package所在的地址 * @param packageName package的名字 * @throws ClassNotFoundException
     */
    ...
    /**
     * 根据classNames中类名，加载所有类 * @param classNames 需要加载的类名集合 * @throws ClassNotFoundException
     */
    ...
    /**
     * 加载类名为className的类 * @param className 需要加载的类名 * @return * @throws ClassNotFoundException
     */
